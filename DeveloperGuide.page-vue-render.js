...
with(this){return _c('p',[_c('strong',[_v("Use case: Delete a contact by "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list persons.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a contact by inputting the contact’s "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")]),_v(".")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays the list of contacts with matching names.")])]),_v(" "),_c('li',[_c('p',[_v("User chooses the desired contact to delete.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect deletes the specified contact and informs the user of the successful deletion.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The inputted common attribute is invalid as it does not correspond to a valid attribute within CraftConnect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user of the constraints of the invalid attributes.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("6a. User cancels the deletion action.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("CraftConnect informs the user that the deletion has been cancelled.")]),_v(" "),_c('p',[_v("Use case ends.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('em',[_v("{More to be added}")])])}
},function anonymous(
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 25 Mar 2025, 16:01:08 GMT+8]")])])])}
}];
