...
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The email (if specified) is not in the correct email format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CraftConnect shows an error message and informs the user that the email is not in the correct format, and shows the user how an email should look like.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The email (if specified) is duplicated.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. CraftConnect shows an error message and informs the user that the email is already used for an existing contact, and shows the said contact.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. The phone number (if specified) is duplicated.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. CraftConnect shows an error message and informs the user that the phone number is already used for an existing contact, and shows the said contact.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Thu, 20 Mar 2025, 0:12:05 GMT+8]")])])])}
}];
