...
with(this){return _c('p',[_c('a',{attrs:{"href":"#acknowledgements"}},[_v("Acknowledgements")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#setting-up-getting-started"}},[_v("Setting up, getting started")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#design"}},[_v("Design")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('a',{attrs:{"href":"#architecture"}},[_v("Architecture")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#ui-component"}},[_v("UI components")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#logic-component"}},[_v("Logic component")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#model-component"}},[_v("Model component")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#storage-component"}},[_v("Storage component")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#common-classes"}},[_v("Common classes")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#implementation"}},[_v("Implementation")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('a',{attrs:{"href":"#proposed-undoredo-feature"}},[_v("[Proposed] Undo/redo feature")]),_v(" "),_c('ul',[_c('li',[_c('a',{attrs:{"href":"#proposed-implementation"}},[_v("Proposed implementation")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#design-considerations"}},[_v("Design considerations")])])])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#proposed-data-archiving"}},[_v("[Proposed] Data archiving")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#documentation-logging-testing-configuration-dev-ops"}},[_v("Documentation, logging, testing, configuration, dev-ops")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('a',{attrs:{"href":"#appendix-requirements"}},[_v("Appendix: Requirements")])])}
},function anonymous(
) {
...
with(this){return _c('p',[_c('a',{attrs:{"href":"#appendix-instructions-for-manual-testing"}},[_v("Appendix: Instructions for manual testing")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('a',{attrs:{"href":"#launch-and-shutdown"}},[_v("Launch and shutdown")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#deleting-a-contact"}},[_v("Deleting a contact")])]),_v(" "),_c('li',[_c('a',{attrs:{"href":"#saving-data"}},[_v("Saving data")])])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"note-feature"}},[_v("Note Feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#note-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_c('strong',[_v("Current implementation:")]),_v(" Uses the index of the contact in the current list")]),_v(" "),_c('ul',[_c('li',[_v("Pros: Easy to implement, and easy to understand")]),_v(" "),_c('li',[_v("Cons: The index of the contact may change if the user filters the list, and the user may not remember the index of the contact they want to edit.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Alternative 1:")]),_v(" Uses a contact's attributes")]),_v(" "),_c('ul',[_c('li',[_v("Pros: The user can use any attribute of the contact to identify it (name, phone, email, etc.)")]),_v(" "),_c('li',[_v("Cons: The attribute chosen may not be unique and can cause confusion")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("is a business owner, preferably in arts and crafts")]),_v(" "),_c('li',[_v("has a need to manage a significant number of contacts")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast and/or prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("new user")]),_v(" "),_c('td',[_v("see usage instructions")]),_v(" "),_c('td',[_v("refer to instructions when I forget how to use the App")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new person")]),_v(" "),_c('td')]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a person by unique attributes")]),_v(" "),_c('td',[_v("remove entries that I no longer need just by knowing one piece of unique data")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("edit a person's contact")]),_v(" "),_c('td',[_v("update the person's information quickly without having to delete and re-add the person")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("filter people by common attributes")]),_v(" "),_c('td',[_v("locate details of persons without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find people by unique attributes")]),_v(" "),_c('td',[_v("locate the full details of a person just by knowing his/her phone number or email")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("clear all contacts")]),_v(" "),_c('td',[_v("start an entirely new instance of the address book")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("export my contacts to a file")]),_v(" "),_c('td',[_v("back up my contacts or share them with others")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("import new data from a file")]),_v(" "),_c('td',[_v("restore my address book or merge contacts from another source")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a note to a contact by index")]),_v(" "),_c('td',[_v("add specific information about certain contacts")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("undo the most recent change to the contact list")]),_v(" "),_c('td',[_v("restore an incorrect edit or delete")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("restore the most recently undone change to the contact list")]),_v(" "),_c('td',[_v("restore an accidentally undone change")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("CraftConnect")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("user")]),_v(", unless specified otherwise)\n"),_c('br'),_c('br'),_c('br'),_v(" "),_c('strong',[_v("Use case: See the usage instruction")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User requests to see the usage instructions.")]),_v(" "),_c('li',[_v("CraftConnect displays the usage instructions.\n"),_c('br'),_c('br'),_c('br')])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User specifies the new contact information ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Name")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Phone Number")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Address")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Category")]),_v(")")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect adds the new contact and informs the user of the successful addition.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. The user fails to specify the contact name, email, phone number or address.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CraftConnect shows an error message and informs the user of the correct command format.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1b. The phone number (if specified) is not in the correct phone number format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1b1. CraftConnect shows an error message and informs the user that the phone number is not in the correct format,\nand shows the user the correct format for a phone number.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1c. The email (if specified) is not in the correct email format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1c1. CraftConnect shows an error message and informs the user that the email is not in the correct format,\nand shows the user the correct format for an email.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1d. The phone number (if specified) is already used by an existing contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1d1. CraftConnect shows an error message and informs the user that the phone number is already used by an existing contact, and shows the said contact.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("1e. The email (if specified) is already used by an existing contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1e1. CraftConnect shows an error message and informs the user that the email is already used by an existing contact, and shows the said contact.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Delete a contact by unique attributes ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Index")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Phone Number")]),_v(")")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to delete a contact by inputting the contact’s unique attribute ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Index")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Phone Number")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect deletes the specified contact and informs the user of the successful deletion.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The input is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user on the correct input syntax.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. A non-unique attribute is supported.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. CraftConnect shows an error message and informs the user that the user's attribute is not a unique attribute.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. No contacts matching the user's supported value.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. CraftConnect shows an error message and informs the user that no contact matches their value.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Edit an existing contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to edit a contact by specifying the index of the contact, the attributes to be changed and the changed attributes.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect edits the specified contact accordingly and informs the user of the successful edit.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The inputted index is invalid as it does not correspond to a valid index within CraftConnect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user that the inputted index is invalid.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. The inputted attributes are invalid as it does not correspond to a valid attribute within CraftConnect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. CraftConnect shows an error message and informs the user of the constraints of the invalid attributes.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. The email (if specified) is not in the correct email format.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. CraftConnect shows an error message and informs the user that the email is not in the correct format, and shows the user how an email should look like.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3d. The email provided (if specified) is a duplicate.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3d1. CraftConnect shows an error message, informing the user of the contact which is already using the email.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3e. The phone number provided (if specified) is a duplicate.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3e1. CraftConnect shows an error message, informing the user of the contact which is already using the phone number.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3f. The inputted attributes are the same as the old attributes of the contact")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3f1. CraftConnect shows an error message, informing the user that the inputted attributes are the same as the old attributes of the contact.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Find a contact by a unique attribute (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Phone")]),_v(")")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User request to view the contact with the corresponding unique attribute ("),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Email")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Phone")]),_v(").")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays the contact that match the inputted attribute.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to filter contacts by specifying a common attribute.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts that match the inputted attribute.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The input is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user of the constraints of the invalid attributes.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. More than one attribute is specified.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. CraftConnect shows an error message and informs the user that only one common attribute should be specified.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. The inputted attribute is not unique.")]),_v(" "),_c('ul',[_c('li',[_v("3c1. CraftConnect shows an error message and informs the user that the attribute they specified is unique, while\nalso suggesting the user to use the find functionality if he/she wants to search using a unique attribute.\n"),_c('br'),_c('br'),_c('br')])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays a list of contacts.")])]),_v(" "),_c('li',[_c('p',[_v("User requests to clear all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect deletes all contacts and informs the user of the successful deletion.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('p',[_c('strong',[_v("Use case: Export contacts to a file")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to export data by specifying the folder to store the data file, and the flag whether to create\na new folder if their specified folder does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect exports the data into a JSON file, stores it in the user's folder and informs the successful export.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The entire input is invalid (anything not conformed to 1 create-folder-option and 1 path)")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CraftConnect shows an error message and informs the user of the correct command usage.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The folder path is invalid (OS-dependent)")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. CraftConnect shows an error message and asks the user to check for spelling.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])]),_v(" "),_c('li')])]),_v(" "),_c('li',[_c('p',[_v("2c. The folder does not exist, and the option of creating folder if not exists is not specified")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. CraftConnect shows an error message and tells the user to check for spelling or specify\ncreate-folder-if-not-exist.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. Some I/O error has occurred when creating folders or the file.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. CraftConnect shows an error message and tells the user to check disk space or use another path.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Import contacts from a file")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to import data by specifying the path to the file.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect replaces the address book contacts with the data from the file and informs the user of the successful\nimport.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The input is empty")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CraftConnect shows an error message and informs the user of the correct command usage.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The path to the file is invalid, or is valid but the file does not exist at that location")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. CraftConnect shows an error message and asks the user to check for spelling or choose an existent path.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])]),_v(" "),_c('li')])]),_v(" "),_c('li',[_c('p',[_v("2c. The file is not a JSON file")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. CraftConnect shows an error message and asks the user to specify the path to a JSON file.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. The JSON file does not follow CraftConnect's schema")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. CraftConnect shows an error message and tells the user the schema it uses to store contacts' data.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Add a note to a contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User request to list contacts.")]),_v(" "),_c('li',[_v("CraftConnect displays a list of contacts.")]),_v(" "),_c('li',[_v("User requests to update the note of a specific contact by inputting the index and the new note.")]),_v(" "),_c('li',[_v("CraftConnect updates the contact's note and indicates success.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to undo the most recent change to the contact list")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect restores the state of the contact list to before the most recent change")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. There are no changes to undo")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CraftConnect shows an error message and informs the user that there are no changes to undo.")]),_v(" "),_c('p',[_v("Use case ends.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: Restore the most recent undone change to the contact list")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to restore the most recent undone change to the contact list")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect restores the state of the contact list to after the undone change")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("1a. There are no changes to restore")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("1a1. CraftConnect shows an error message and informs the user that there are no changes to restore.")]),_v(" "),_c('p',[_v("Use case ends.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Performance")])]),_v(" "),_c('ul',[_c('li',[_v("CraftConnect should initialize within 2 seconds on a mid-tier computer.")]),_v(" "),_c('li',[_v("CraftConnect should be able to hold up to 1000 contacts while keeping all operations under 100ms.")]),_v(" "),_c('li',[_v("CraftConnect should not exceed 200MB RAM during peak operations.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Reliability and Security")])]),_v(" "),_c('ul',[_c('li',[_v("In case of crashing, no data should be lost beyond the last data-modifying operation.")]),_v(" "),_c('li',[_v("CraftConnect should save backup files every 24 hours.")]),_v(" "),_c('li',[_v("CraftConnect should check for corrupted or missing data files and restore automatically.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Usability and Accessibility")])]),_v(" "),_c('ul',[_c('li',[_v("All errors should be clear and actionable (e.g. if the wrong email format is used, tell the user how a correct email should look like).")]),_v(" "),_c('li',[_v("A user with above-average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")])])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Portability")])]),_v(" "),_c('ul',[_c('li',[_v("CraftConnect should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Any user should be able to run CraftConnect without needing to install any other applications/dependencies (except Java 17)")])])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Mid-tier computer")]),_v(": A computer that is typically used for office operations and software development, but not strong enough to handle moderate gaming. For minimum-spec reference,\n"),_c('ul',[_c('li',[_v("Processor (CPU): Intel Core i3 (2nd Gen)/AMD Athion 64 X2")]),_v(" "),_c('li',[_v("Memory (RAM): 2GB RAM")]),_v(" "),_c('li',[_v("Storage (HDD/SDD): 100MB of free disk space")]),_v(" "),_c('li',[_v("Graphics: Integrated GPU (Intel HD Graphics 300 or equivalent)")]),_v(" "),_c('li',[_v("Disk Speed: HDD (5400 RPM) or SSD if available.")])])]),_v(" "),_c('li',[_c('strong',[_v("Contacts")]),_v(": Contacts are considered to be unique if and only if they have a unique email and phone number. Thus, two contacts can still have the same names")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Fri, 4 Apr 2025, 14:12:20 GMT+8]")])])])}
}];
