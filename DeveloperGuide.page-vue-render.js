...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to see the usage instructions.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect displays the usage instructions.")]),_v(" "),_c('p',[_v("Use case ends.\n"),_c('br'),_c('br'),_c('br')])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The input is invalid.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user on the correct input syntax.")]),_v(" "),_c('p',[_c('strong',[_v("NOTE")]),_v(": : a non-positive index or an index outside the range of a Java integer results in an invalid command format\nexception, because these can be detected during the parsing phase. A positive index that is outside the range\nof the contact list can only be detected at command execution phase, so another message will be returned.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. A non-unique attribute is supported.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. CraftConnect shows an error message and informs the user that the user's attribute is not a unique attribute.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.")])])])]),_v(" "),_c('li',[_c('p',[_v("3c. No contacts matching the user's supported value.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3c1. CraftConnect shows an error message and informs the user that no contact matches their value.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to import data by specifying the path to the file, whether to overwrite existing contacts with the\nnew contacts from the JSON file or to append new contacts into the existing contacts, and whether to ignore duplicated\ncontacts.")])]),_v(" "),_c('li',[_c('p',[_v("CraftConnect replaces the address book contacts with the data from the file and informs the user of the successful\nimport.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The input is empty")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. CraftConnect shows an error message and informs the user of the correct command usage.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2b. The path to the file is invalid, or is valid but the file does not exist at that location")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2b1. CraftConnect shows an error message and asks the user to check for spelling or choose an existent path.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2c. The file is not a JSON file")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2c1. CraftConnect shows an error message and asks the user to specify the path to a JSON file.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2d. The JSON file does not follow CraftConnect's schema")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2d1. CraftConnect shows an error message and tells the user the schema it uses to store contacts' data.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])]),_v(" "),_c('li',[_c('p',[_v("2e. (Exclusive to when duplicates are not ignored) The JSON file contains duplicated contacts within itself, or it\ncontains duplicated contacts with an existing contact in append mode.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2e1. CraftConnect shows an error message about duplicated contacts.")]),_v(" "),_c('p',[_v("Use case resumes at step 1.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('br'),_c('br'),_c('br')])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. The inputted index is invalid as it does not correspond to a valid index within CraftConnect.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. CraftConnect shows an error message and informs the user that the inputted index is invalid.")]),_v(" "),_c('p',[_c('strong',[_v("NOTE")]),_v(": a non-positive index or an index outside the range of a Java integer results in an invalid command format\nexception, because these can be detected during the parsing phase. A positive index that is outside the range\nof the contact list can only be detected at command execution phase, so another message will be returned.")]),_v(" "),_c('p',[_v("Use case resumes at step 3.\n"),_c('br'),_c('br'),_c('br')])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all contacts using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. Multiple contacts in the list.")])]),_v(" "),_c('li',[_c('p',[_v("If there is not a contact with phone number 123, add a contact with such a phone number.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/dummy e/dummy@example.com p/123 a/dummydummy")]),_v("\nIf there is not a contact with phone number 456, add a contact with such a phone number.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/dummy2 e/dummy2@example.com p/456 a/dummydummy2")]),_v("\nIf there is not a contact with email address "),_c('a',{attrs:{"href":"mailto:dummy3@example.com"}},[_v("dummy3@example.com")]),_v(", add a contact with such an email address.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/dummy3 e/dummy3@example.com p/789 a/dummydummy3")]),_v("\nIf there is not a contact with email address "),_c('a',{attrs:{"href":"mailto:dummy4@example.com"}},[_v("dummy4@example.com")]),_v(", add a contact with such an email address.\n"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/dummy4 e/dummy4@example.com p/012 a/dummydummy4")])])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First contact is deleted from the list. Details of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No contact is deleted. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete p/123")]),_c('br'),_v("\nExpected: the contact with phone number 123 is deleted.\nDetails of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter a/5")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete p/456")]),_v("\nExpected: even though the contact with phone number 456 is filtered out, deletion by phone number still succeeds.\nDetails of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete e/dummy3@example.com")]),_c('br'),_v("\nExpected: the contact with the email address "),_c('a',{attrs:{"href":"mailto:dummy3@example.com"}},[_v("dummy3@example.com")]),_v(" is deleted.\nDetails of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("filter a/5")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete e/dummy4@example.com")]),_v("\nExpected: even though the contact with email address "),_c('a',{attrs:{"href":"mailto:dummy4@example.com"}},[_v("dummy4@example.com")]),_v(" is filtered out, deletion by email address still succeeds.\nDetails of the deleted contact shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try:")]),_v(" "),_c('ul',[_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(" (where x is larger than the list size)")]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete e\\NON_EXISTENT_EMAIL")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete p\\NON_EXISTENT_PHONE")])]),_v(" "),_c('li',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("...")]),_v("\nExpected: No contact is deleted. Error details shown in the status message. Status bar remains the same.")])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.6.0")]),_v(", generated on Tue, 8 Apr 2025, 1:58:29 GMT+8]")])])])}
}];
